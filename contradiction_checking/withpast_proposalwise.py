...
with open("../results/contradiction_checking/withpast_proposalwise.log", "w", encoding="utf8") as file:
...
with open("../results/contradiction_checking/withpast_proposalwise_metrics.log", "w", encoding="utf8") as file:
