...
with open(f"../results/contradiction_checking/{consultation_name}/{model_name}/withpast_sentencecouple_contradictionshare.log", "w", encoding="utf8") as file:
...
with open(f"../results/contradiction_checking/{consultation_name}/{model_name}/withpast_sentencecouple_contradictionshare_metrics.log", "w", encoding="utf8") as file:
