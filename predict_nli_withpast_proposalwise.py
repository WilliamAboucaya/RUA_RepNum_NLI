...
def apply_strategy(proposals_couples: pd.DataFrame, model_checkpoint: str, model_revision: str, batch_size: int) -> pd.DataFrame:
    ...
    print("Number batches = " + str(nb_batches))
...
if __name__ == "__main__":
    ...
    with open(f"results/all_data/{input_consultation_name}/{input_model_name}{('_' + input_model_revision) if input_model_revision != 'main' else ''}/removepast_proposalwise.log", "w", encoding="utf8") as file:
    ...
    with open(f"results/all_data/{input_consultation_name}/{input_model_name}{('_' + input_model_revision) if input_model_revision != 'main' else ''}/removepast_proposalwise_metrics.log", "w", encoding="utf8") as file:
